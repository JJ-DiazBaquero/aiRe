comparativeAnalysisUI <- function(id) {
  ...
  navbarPage(
    ...
    tabPanel("Fechas Personalizadas",
             ...
             sliderInput(ns("rangeYear1"), "Años:",
                         min = 1998, max = 2016, value = c(1998,2016)),
             sliderInput(ns("rangeMonth1"), "Mes:",
                         min = 1, max = 12, value = c(1,12)),
             selectInput(ns("typeOfWeek1"), label = "Numeración de semanas:", 
                         choices = list("Días de la semana" = 0, "Número del día" = 1), 
                         selected = 0),
             uiOutput(ns("weekui1")),
             ...
             column(4,
                    ...
                    sliderInput(ns("rangeYear2"), "Años:",
                                min = 1998, max = 2016, value = c(1998,2016)),
                    sliderInput(ns("rangeMonth2"), "Mes:",
                                min = 1, max = 12, value = c(1,12)),
                    selectInput(ns("typeOfWeek2"), label = "Numeración de semanas:", 
                                choices = list("Días de la semana" = 0, "Número del dia" = 1), 
                                selected = 0),
                    uiOutput(ns("weekui2")),
             ...
             column(4,
                    ...
                    sliderInput(ns("rangeYear3"), "Años:",
                                min = 1998, max = 2016, value = c(1998,2016)),
                    sliderInput(ns("rangeMonth3"), "Mes:",
                                min = 1, max = 12, value = c(1,12)),
                    selectInput(ns("typeOfWeek3"), label = "Numeración de semanas:", 
                                choices = list("Días de la semana" = 0, "Número del dia" = 1), 
                                selected = 0),
                    uiOutput(ns("weekui3")),
    ...
    tabPanel("Graficos",
             ...
             hr(),
             h2("Análisis de valores atípicos"),
